...
public class SimplifiedOdometryRobot {
    ...
    public void initialize(boolean showTelemetry) {
        ...
        leftFrontDrive = setupDriveMotor("LF", DcMotor.Direction.FORWARD);
        rightFrontDrive = setupDriveMotor("RF", DcMotor.Direction.REVERSE);
        leftBackDrive = setupDriveMotor("LB", DcMotor.Direction.FORWARD);
        rightBackDrive = setupDriveMotor("RB", DcMotor.Direction.REVERSE);
        ...
        RevHubOrientationOnRobot orientationOnRobot = new RevHubOrientationOnRobot(RevHubOrientationOnRobot.LogoFacingDirection.UP, RevHubOrientationOnRobot.UsbFacingDirection.RIGHT);
